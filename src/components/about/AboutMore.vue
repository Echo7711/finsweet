<template>
  <div class="more">
    <div class="more-left">
      <span style="color: #FAB175;">KNOW MORE ABOUT US ——</span><br>
      <span style="font-size: 3rem;">We source sustainable & line caught Foods</span>
    ...
    <div class="more-right">
      <img style="margin: 5rem 0 0 1rem;" src="@/assets/about/more_img1.png" />
      <img style="margin: 0 0 5rem 6rem;" src="@/assets/about/more_img2.png" />
    </div>
  </div>
</template>
